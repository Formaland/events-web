...
class Customer extends BaseUser
{
     ...
     * @var Bookings
     *
     * @ORM\OneToMany(targetEntity="Pfe\Bundle\BookingBundle\Entity\Booking", mappedBy="customer", cascade={"remove"})
     */
    protected $bookings;
     ...
     * Add bookings
     *
     * @param \Pfe\Bundle\BookingBundle\Entity\Booking $bookings
     * @return Customer
     */
    public function addBooking(\Pfe\Bundle\BookingBundle\Entity\Booking $bookings)
    {
     ...
     * @param \Pfe\Bundle\BookingBundle\Entity\Booking $bookings
     */
    public function removeBooking(\Pfe\Bundle\BookingBundle\Entity\Booking $bookings)
    {
