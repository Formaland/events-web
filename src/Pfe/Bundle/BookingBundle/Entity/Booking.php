...
class Booking
{
     ...
     * Set event
     *
     * @param \Pfe\Bundle\EventBundle\Entity\Event $event
     * @return Booking
     */
    public function setEvent(\Pfe\Bundle\EventBundle\Entity\Event $event = null)
    {
        $this->event = $event;
     ...
     * Get event
     *
     * @return \Pfe\Bundle\EventBundle\Entity\Event 
     */
